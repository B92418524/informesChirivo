    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <form method="post" action="functions/render/ajax/cambiar-empresa.php">
                <select id="selEmpresaMenu" name="selEmpresa" style="position:relative;width:320px;top:8px" class="form-control" onchange="this.form.submit()">
                    <option value="1">1 - CHIRIVO CONSTRUCCIONES S.L.</option>
                    <option value="2">2 - TORCAL INFRAESTRUCTURAS</option>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">                        
                        ...
                        <li><a href="rendimiento-obras.php" target="_blank">Rendimiento de obras</a></li>
                        <li><a href="detalle-rendimiento-obras.php" target="_blank">Detalle rendimiento de obra</a></li>
                        <li><a href="informe-4d1.php" target="_blank">Estado informes Jefes de Obra</a></li>
                        <li><a href="facturacion-mensual.php" target="_blank">Facturaci&oacute;n mensual</a></li>
                        <li class="divider"></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="informe-13.php" target="_blank">Gastos medios materiales completo</a></li>
                        <li><a href="informe-17.php" target="_blank">Gastos medios materiales simple</a></li>
                        ...
                        <li><a href="informe-20.php" target="_blank">Cartera de obra anual</a></li>
                        <li><a href="facturacion-global-proveedores.php" target="_blank">Facturaci&oacute;n global proveedores</a></li>
                        <li><a href="diario-facturas-clientes.php" target="_blank">Diario de facturas de clientes</a></li>
                        <li><a href="#"></a></li>
                    </ul>
                </li>
                <li class="dropdown">
