...
function editar_informe_procesado ($content) {
	...
	$replaces=array(
			...
			'{PF_APROBACION_V}'				=>		$PF_APROBACION_V,
			'{PF_OTROS_V}'					=>		$PF_OTROS_V,
			'{TOTAL_PENDIENTE_COBRO_V}'		=>		$TOTAL_PENDIENTE_COBRO_V > 0 ? $TOTAL_PENDIENTE_COBRO_V : '{TOTAL_PENDIENTE_COBRO_V}',
			'{TOTAL_PENDIENTE_DE_PAGO_V}'	=>		$TOTAL_PENDIENTE_DE_PAGO_V > 0 ? $TOTAL_PENDIENTE_DE_PAGO_V : '{TOTAL_PENDIENTE_DE_PAGO_V}',
			'{PAGO_ANTICIPADO_REALIZADO_V}' =>      $PAGO_ANTICIPADO_REALIZADO_V > 0 ? $PAGO_ANTICIPADO_REALIZADO_V : '{PAGO_ANTICIPADO_REALIZADO_V}',
			'{OBSERVACIONES_GENERALES_V}'	=>		$OBSERVACIONES_GENERALES_V,
			'{MOTIVOS_V}'                   =>      $MOTIVOS_V
